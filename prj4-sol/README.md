The web services created in the previous sub-project are used to display a rudimentary UI which allows displaying and updating spreadsheets using a browser.
